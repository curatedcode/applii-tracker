...
export const defaultFocusHoverClasses =
	"outline-none transition focus-within:outline-none hover:opacity-95 focus:outline-none focus-visible:ring-1 focus-visible:ring-dark-secondary focus-visible:ring-opacity-75 focus-visible:ring-offset-dark-secondary dark:focus-visible:ring-light-secondary dark:focus-visible:ring-offset-light-secondary";
