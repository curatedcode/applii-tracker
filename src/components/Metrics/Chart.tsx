...
export function Chart({ data, totalApplications }: ChartProps) {
	...
	return (
		<div
			className="h-[25rem] w-full overflow-hidden text-light-text dark:text-dark-text sm:flex"
		...
		>
			<ResponsiveBar
				...
				keys={chartStageKeys}
				indexBy="date"
				margin={{ top: 100, right: 25, bottom: 75, left: 50 }}
				padding={0.3}
				...
				legends={[
					{
						...
						data: [
							{
								label: "Need To Apply",
								color: statusColors.needToApply,
								id: "needToApplyLegendKey",
							},
							{
								label: "Applied",
